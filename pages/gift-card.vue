        ...
        <section>
            <div class="flex flex-col-reverse lg:flex-row gap-10">
                <div class="w-full lg:w-1/2">
                    ...
                    <h1 class="text-xl mt-6 font-semibold text-center">eGift card amount</h1>
                    <div class="border rounded flex max-w-[420px] mx-auto overflow-hidden"
                        style="border-color: #FCDD80;">
                        <div class="flex-1 border-r" style="border-color: #FCDD80;">
                            <button class="w-full py-3 text-sm sm:text-base md:text-lg text-center"> $25.00 </button>
                        </div>
                        <div class="flex-1 border-r" style="border-color: #FCDD80;">
                            <button class="w-full py-3 text-sm sm:text-base md:text-lg text-center"> $35.00 </button>
                        </div>
                        <div class="flex-1 border-r" style="border-color: #FCDD80;">
                            <button class="w-full py-3 text-sm sm:text-base md:text-lg text-center"> $50.00 </button>
                        </div>
                        <div class="flex-1 border-r" style="border-color: #FCDD80;">
                            <button class="w-full py-3 text-sm sm:text-base md:text-lg text-center"> $100.00 </button>
                        </div>
                        <div class="flex-1">
                            <button class="w-full py-3 text-sm sm:text-base md:text-lg text-center"> Custom </button>
                        </div>
                    </div>
